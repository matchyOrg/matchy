  ...
  <v-main>
    <v-container>
      ...
      <p>
        ...
        for the applications core functionality: user credentials to stay logged
        in.
      </p>
      ...
      <p class="mt-5">
        Although the server is certified to be secure, the API is not. We do not
        take any liabalities for data breaches or misuses of the service. This
        service is just a proof of concept and is not intended for commercial
        use.
      </p>
      <p class="mt-5 mb-10">
